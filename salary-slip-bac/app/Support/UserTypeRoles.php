...
class UserTypeRoles
{
    ...
    private const CODES = [
        ...
        self::ADMIN => ['tenant_administrator', 'admin', 'hr_manager', 'hr', 'hr_admin', 'hr_administrator', 'account_manager', 'accountant', 'account', 'accounts', 'accounts_head', 'accounts_manager', 'payroll_manager', 'payroll_admin'],
