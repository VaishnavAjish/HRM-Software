...
/**
 * Allocates the next Mediclaim claim number, e.g. MC-NIDHI-IMPEX-2026-000145.
 *
 * Business rule 1 is that every claim has a unique number, and the obvious
 * implementation — max(claim_number) + 1 — cannot deliver it. Two employees
 ...
 * written. This mirrors `TicketNumber` instead.
 */
class MediclaimClaimNumber
{
     ...
     * Callers already open one to write the claim and its first event row
