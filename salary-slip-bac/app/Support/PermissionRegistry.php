...
class PermissionRegistry
{
    ...
    private const NODES = [
        ...
        'ui.hr.organization' => [
            'type' => self::TYPE_PAGE, 'label' => 'Organization', 'order' => 35,
            'parent' => 'ui.hr', 'route' => '/admin/hr/organization',
            'description' => 'Open the organization workspace.',
            'implies' => ['hr.dashboard.read'],
            'scopes' => [self::SCOPE_COMPANY],
        ],
        'ui.hr.organization.overview' => [
            'type' => self::TYPE_FEATURE, 'label' => 'Overview', 'order' => 10,
            'parent' => 'ui.hr.organization',
            'description' => 'Read the organization structure overview.',
            'implies' => ['org.unit.read'],
        ],
        'ui.hr.organization.companies' => [
            'type' => self::TYPE_FEATURE, 'label' => 'Companies & Departments', 'order' => 20,
            'parent' => 'ui.hr.organization',
            'description' => 'Read the companies and departments tabs.',
            'implies' => ['admin.company.read'],
        ],
        'ui.hr.organization.designations' => [
            'type' => self::TYPE_FEATURE, 'label' => 'Designations', 'order' => 30,
            'parent' => 'ui.hr.organization',
            'description' => 'Read the designations held by each unit.',
            'implies' => ['org.unit_position.read'],
        ],
        'ui.hr.organization.org_chart' => [
            'type' => self::TYPE_FEATURE, 'label' => 'Org Chart', 'order' => 40,
            'parent' => 'ui.hr.organization',
            'description' => 'Read the organization chart.',
            'implies' => ['org.chart.read'],
        ],
        'ui.hr.organization.assignments' => [
            'type' => self::TYPE_FEATURE, 'label' => 'Assignments', 'order' => 50,
            'parent' => 'ui.hr.organization',
        ...
        'ui.hr.organization.promotions_transfers' => [
            ...
            'parent' => 'ui.hr.organization',
            'description' => 'Read promotion and transfer history.',
            'implies' => ['org.change.read'],
        ],
        'ui.hr.assets' => [
