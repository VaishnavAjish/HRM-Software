...
class OrganizationChangeManagementController extends Controller
{
    ...
    public function storePromotionTransfer(Request $request): JsonResponse
    {
        $data = $request->validate([
            ...
            'positionTitle' => ['sometimes', 'nullable', 'string', 'max:190'],
            'targetRole' => ['sometimes', 'nullable', 'string', 'max:190'],
            'designationId' => ['sometimes', 'nullable'],
            'designationTitle' => ['sometimes', 'nullable', 'string', 'max:190'],
            'targetDesignation' => ['sometimes', 'nullable', 'string', 'max:190'],
