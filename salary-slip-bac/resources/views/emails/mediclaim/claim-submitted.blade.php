...
<head>
    ...
    <title>Mediclaim Claim Submitted &ndash; NISS HRMS</title>
</head>
                ...
                <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="background:linear-gradient(135deg,#0891b2 0%,#0e7490 100%);padding:32px 40px;text-align:center;">
                            ...
                            <p style="margin:6px 0 0;color:#a5f3fc;font-size:13px;">Mediclaim &middot; Claim Submitted</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:40px 40px 32px;">
                            ...
                            <p style="margin:0 0 24px;color:#4b5563;font-size:15px;line-height:1.7;">
                                Your Mediclaim claim has been submitted and is now under review.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:20px 24px;">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding:6px 0;color:#155e75;font-size:13px;font-weight:600;">Claim number</td>
                                                <td style="padding:6px 0;color:#083344;font-size:13px;text-align:right;">{{ $claimNumber }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:6px 0;color:#155e75;font-size:13px;font-weight:600;">Status</td>
                                                <td style="padding:6px 0;color:#083344;font-size:13px;text-align:right;">Under review</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <p style="margin:0;color:#9ca3af;font-size:13px;line-height:1.6;">
                                You can track your claim's progress at any time from the Mediclaim section of the HRMS portal.
                            </p>
                        </td>
                    </tr>
