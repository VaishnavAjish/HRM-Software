...
const pageTitles = {
  ...
  "/admin/organization/enterprises": "Enterprises",
  "/admin/organization/legal-entity-profiles": "Legal Entity Profiles",
  "/admin/organization/org-units": "Organization Units",
  "/admin/organization/positions": "Positions",
  "/admin/organization/assignments": "Assignments",
  "/admin/organization/org-locations": "Organization Locations",
  "/admin/organization/location-types": "Location Types",
  "/admin/organization/financial-organizations": "Financial Organizations",
  "/admin/organization/gl-mappings": "GL Mappings",
  "/admin/organization/allocation-rules": "Allocation Rules",
  "/admin/organization/allocation-lines": "Allocation Lines",
  "/admin/organization/hierarchies": "Hierarchies",
  "/admin/organization/hierarchy-nodes": "Hierarchy Nodes",
  "/admin/organization/hierarchy-edges": "Hierarchy Edges",
  "/admin/organization/reporting-structure": "Reporting Structure",
  "/admin/organization/org-chart": "Org Chart",
  "/admin/organization/change-management": "Change Management",
  "/admin/organization/calendar-assignments": "Calendar Assignments",
};
