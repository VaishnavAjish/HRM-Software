    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 px-5 pt-1 flex items-start justify-between min-w-0 flex-shrink-0", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "h-12 w-20 rounded-xl bg-white border border-gray-200 p-1 shadow-sm flex items-center justify-center flex-shrink-0 overflow-hidden", children: theme.logo ? /* @__PURE__ */ jsx("img", { src: theme.logo, alt: "Logo", crossOrigin: "anonymous", className: "h-full w-full object-contain" }) : /* @__PURE__ */ jsx("span", { className: "text-[7.5px] font-bold text-gray-400 text-center uppercase leading-tight", children: "YOUR LOGO" }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 px-5 pt-1 flex-1 flex flex-col items-center justify-between min-h-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "w-full flex items-end justify-between gap-2 px-1 mb-1", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end text-right", children: [
              theme.signatureUrl ? /* @__PURE__ */ jsx(
                "img",
                {
              ...
              /* @__PURE__ */ jsx("span", { className: "text-[8.5px] font-serif italic text-slate-600 mt-0.5", children: theme.signatureTitle || "Authorized Signatory" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx(
