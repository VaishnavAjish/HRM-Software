...
function headers(accessToken, tokenType = "Bearer") {
  ...
  const formattedType = tokenType ? tokenType.charAt(0).toUpperCase() + tokenType.slice(1) : "Bearer";
...
export const mediclaimApi = {
  ...
  submitReviewDecision(claimId, payload, accessToken, tokenType = "Bearer") {
    const body = { ...payload };
    if (body.approvedAmount !== void 0 && body.approved_amount === void 0) {
      body.approved_amount = body.approvedAmount;
    }
    if (body.approved_amount !== void 0 && body.approvedAmount === void 0) {
  ...
  updateHospitalContact(hospitalId, contactId, { name, designation, phone, email, availability, photo } = {}, accessToken, tokenType = "Bearer") {
    const formData = new FormData();
    if (name !== void 0) formData.append("name", name);
    if (designation !== void 0) formData.append("designation", designation || "");
    if (phone !== void 0) formData.append("phone", phone);
    if (email !== void 0) formData.append("email", email || "");
    if (availability !== void 0) formData.append("availability", availability || "");
    if (photo) formData.append("photo", photo);
