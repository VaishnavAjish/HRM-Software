...
export default function MediclaimIdCard({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-3", children: [
    /* @__PURE__ */ jsx("div", { ref: cardContainerRef, className: "inline-block p-1 bg-transparent", children: side === "front" ? /* @__PURE__ */ jsx(IDCardFront, { employee: employeeData }) : /* @__PURE__ */ jsx(IDCardBack, { employee: employeeData }) }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx(RotateCw, { size: 13, className: "text-indigo-600" }),
            " Flip (",
      ...
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          className: "inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-lg border border-gray-300 bg-white text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200",
          children: [
            /* @__PURE__ */ jsx(Eye, { size: 13, className: "text-indigo-600" }),
            " View Pass"
          ]
        }
      ),
    ...
    /* @__PURE__ */ jsx(
      Modal,
      {
        ...
        size: "md",
        children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-4 py-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4 p-2", children: [
            /* @__PURE__ */ jsx(IDCardFront, { employee: employeeData }),
            /* @__PURE__ */ jsx(IDCardBack, { employee: employeeData })
          ] }),
          /* @__PURE__ */ jsxs(
            "button",
            {
